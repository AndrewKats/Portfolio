...
namespace PS2GradingTests
{
    ...
    public class DependencyGraphTest
    {
        ...
        /// <summary>
        /// see if ReplaceDependees adds new data
        /// </summary>
        [TestMethod()]
        public void NonEmptyTest9()
        {
            DependencyGraph t = new DependencyGraph();
            t.ReplaceDependees("c", new HashSet<string>() { "a", "b", "d","e","f","g" });
            HashSet<String> cDees = new HashSet<string>(t.GetDependees("c"));
            Assert.IsTrue(cDees.SetEquals(new HashSet<string>() { "a", "b", "d", "e", "f", "g" }));
        }

        /// <summary>
        /// see if ReplaceDependents adds new data
        /// </summary>
        [TestMethod()]
        public void NonEmptyTest10()
        {
            DependencyGraph t = new DependencyGraph();
            t.ReplaceDependents("c", new HashSet<string>() { "a", "b", "d", "e", "f", "g" });
            HashSet<String> cDents = new HashSet<string>(t.GetDependents("c"));
            Assert.IsTrue(cDents.SetEquals(new HashSet<string>() { "a", "b", "d", "e", "f", "g" }));
        }

        /// <summary>
        /// see if replacing dependency removes old data 
        /// </summary>
        [TestMethod()]
        public void NonEmptyTest11()
        {
            ...
            t.AddDependency("c", "a");
            t.AddDependency("c", "b");
            t.ReplaceDependents("c", new HashSet<string>() {"d", "e", "f", "g" });
            Assert.IsTrue(t["a"] == 0 && t["b"] == 0);
        }

        /// <summary>
        /// see if replacing dependees removes old data 
        /// </summary>
        [TestMethod()]
        public void NonEmptyTest12()
        {
            ...
            t.AddDependency("a", "c");
            t.AddDependency("b", "c");
            t.ReplaceDependees("c", new HashSet<string>() { "d", "e", "f", "g" });
            Assert.IsTrue(t["c"] == 4 && t["a"] == 0 && t["b"] == 0 && t["d"] == 0 && t["e"] == 0 && t["f"] == 0 && t["g"] == 0);
        }


        /// <summary>
        /// test to see if private data is exposed
        /// </summary>
        [TestMethod]
