...
#include "../../LearnToCodeClient/world.h"
...
QT_MOC_LITERAL(1, 6, 8), // "getStats"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 12), // "restartLevel"
QT_MOC_LITERAL(4, 29, 16), // "gameStateChanged"
QT_MOC_LITERAL(5, 46, 5) // "phase"

    },
    "World\0getStats\0\0restartLevel\0"
    "gameStateChanged\0phase"
};
...
void World::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->getStats(); break;
        case 1: _t->restartLevel(); break;
        case 2: _t->gameStateChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&World::getStats)) {
                *result = 0;
            }
        }
        {
            typedef void (World::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&World::restartLevel)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject World::staticMetaObject = {
    { &QSFMLCanvas::staticMetaObject, qt_meta_stringdata_World.data,
